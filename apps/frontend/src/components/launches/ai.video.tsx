      ...
      <div className="relative group">
        <div
          {...(value.length < 30
            ...
            : {})}
          className={clsx(
            'cursor-pointer h-[30px] rounded-[6px] justify-center items-center flex px-[8px] transition-all duration-200',
            value.length < 30 ? 'opacity-50 bg-newColColor' : 'bg-[#048FCC] hover:bg-[#F8AB0C] hover:shadow-md'
          )}
          style={value.length >= 30 ? { backgroundColor: '#048FCC' } : {}}
        >
          {loading && (
          ...
          >
            ...
            <div className="text-[10px] font-[600] iconBreak:hidden block text-gray-900 dark:text-white">{t('ai', 'AI')} Video</div>
          </div>
        </div>
