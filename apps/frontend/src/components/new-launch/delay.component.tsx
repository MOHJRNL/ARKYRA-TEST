    ...
    <div ref={ref} className="relative">
      <div
        ...
        className={clsx(
          ...
          currentDelay > 0 && 'bg-forth hover:bg-forthHover active:bg-forthActive text-textColor rounded-full transition-all'
        )}
      >
        <DelayIcon />
      </div>
            ...
            {delayOptions.map((option) => (
              <div
                ...
                className={clsx(
                  ...
                  currentDelay === option.value && 'bg-forth text-textColor hover:bg-[#048FCC]'
                )}
              >
                {option.label}
              </div>
          ...
          <div className="border-t border-newTextColor/10 mt-[8px] pt-[8px]">
            <div className="flex gap-[4px]">
              <input
                ...
                className={clsx(
                  'flex-1 w-full h-[32px] px-[8px] rounded-[4px] bg-newBgColor border text-[13px] outline-none focus:border-[#048FCC]',
                  isCustomDelay ? 'border-[#048FCC]' : 'border-newTextColor/10'
                )}
              />
              <button
                onClick={(e) => {
                ...
                className="h-[32px] px-[10px] rounded-[4px] bg-forth text-textColor text-[12px] font-[600] hover:bg-[#048FCC]/80"
              >
                Set
              </button>
            </div>
