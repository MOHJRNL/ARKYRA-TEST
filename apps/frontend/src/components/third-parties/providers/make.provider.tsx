      ...
      <FormProvider {...form}>
        ...
        >
          <Input
            ...
            placeholder="Enter your Make (Integromat) API key"
          />
          ...
          <Button type="submit">Connect Make</Button>
        </form>
      </FormProvider>
    </div>
  );
...
export default thirdPartyWrapper('make', MakeProviderComponent);
