...
const LookerStudioProviderComponent = () => {
      ...
      <FormProvider {...form}>
        ...
        >
          ...
          <div className="text-sm text-gray-400 mb-4">
            ...
            with access to Looker Studio
          </div>

          <Button type="submit">Connect Looker Studio</Button>
        </form>
      </FormProvider>
    </div>
  );
...
export default thirdPartyWrapper('looker-studio', LookerStudioProviderComponent);
